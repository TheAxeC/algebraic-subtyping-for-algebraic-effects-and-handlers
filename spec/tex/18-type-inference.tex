...
\[\begin{array}{r@{~}c@{~}l}
    ...
    \inferrule[Hand]{
        ...
        \ctxp \entt \shorthand \T [\ctxm^-_r \intersection (\bigsqcap \ctxm^-_\op | \op \in \ops)](\alpha_1 \E \delta_1 \union \ops \hto \alpha_2 \E \delta_2)
    }\\ \xi = biunify\left(
        \begin{array}{ll}
...
\[\begin{array}{r@{~}c@{~}l}
    ...
    \inferrule[Op]{
        ...
        \ctxp \prinent \op \, v \T [\ctxm^-](\textcolor{red}{B^+} \E \op)
    }
