...
\begin{mathpar} 
    \inferrule[]{}{
        atomic(\beta \le A-) = [\rectype{\beta^-} \intersection [\alpha / \beta^-](A^-) / \beta^-]
    }\\
    \inferrule[]{}{
        atomic(A^+ \le \beta) = [\rectype{\beta^+} \union [\alpha / \beta^+](A^+) / \beta^+]
    }\\
    \inferrule[]{}{
        atomic(\beta \le \gamma) = [\rectype{\beta} \intersection [\alpha / \beta^-](\gamma) / \beta^-] \equiv [\alpha \intersection \gamma/\alpha^-]
    }\\
    
    \inferrule[]{}{
        atomic(\delta \le \dirt-) = 
    }\\
    \inferrule[]{}{
        atomic(\dirt^+ \le \delta) = 
    }\\
    \inferrule[]{}{
        atomic(\delta_1 \le \delta_2) =   
    }
\end{mathpar}
\end{minipage}
\end{framed}
