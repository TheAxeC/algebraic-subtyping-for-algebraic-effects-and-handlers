...
\todo{explain substitutions and bisubstitions}
...
\begin{mathpar}    
    ...
    \inferrule[]{}{
        subi(\op \le \op \union \dirt^-) = \{\}
    }\\
    \inferrule[]{}{
        subi(\op \le \dirt^- \union \op) = \{\}
    }\\
    \inferrule[]{}{
        subi(\op_1 \le \op_2 \union \dirt^-) = \{\op_1 \le \dirt^-\}
    }\\
    \inferrule[]{}{
        subi(\op_1 \le \dirt^- \union \op_2) = \{\op_1 \le \dirt^-\}
    }\\
    \inferrule[]{}{
