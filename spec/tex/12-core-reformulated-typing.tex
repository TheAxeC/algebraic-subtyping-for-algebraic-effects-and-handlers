...
\begin{figure}[!htb]
  ...
  \begin{mathpar}    
      ...
      \inferrule[SubInst]{}{
        [\ctxm_2]A_2 \le^\forall [\ctxm_1]A_1 \leftrightarrow \rho([\ctxm_2]A_2) \le [\ctxm_1]A_1 \text{for some substitution }\rho
      }
      ...
      \inferrule[Weakening]{}{
        \ctxp_2 \equiv^\forall \ctxp_1 \leftrightarrow dom(\ctxp_2) \supseteq dom(\ctxp_1), \ctxp_2(\letvar) \equiv^\forall \ctxp_1(\letvar) \text{ | } \letvar \in dom(\ctxp_1)
      }
  \end{mathpar}
  \end{minipage}
  \end{framed}
...
\begin{minipage}{0.95\columnwidth}
    ...
    \begin{mathpar}
      ...
      \inferrule[Let]{
        ...
        \ctx \entt \letin{\letvar = c_1} c_2 \T [\ctxm_1 \intersection \ctxm_2]B \E \dirt
      }
