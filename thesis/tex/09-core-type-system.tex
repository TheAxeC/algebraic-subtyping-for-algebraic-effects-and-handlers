...
\begin{mathpar}    
    \inferrule[]{}{
        (A_1 \to A_2) \union (A_3 \to A_4) \equiv (A_1 \intersection A_3) \to (A_2 \union A_4)
    }\\

    \inferrule[]{}{
        (A_1 \to A_2) \intersection (A_3 \to A_4) \equiv (A_1 \union A_3) \to (A_2 \intersection A_4)
    }\\

    \inferrule[]{}{
        (A_1 \hto A_2) \union (A_3 \hto A_4) \equiv (A_1 \intersection A_3) \hto (A_2 \union A_4)
    }\\

    \inferrule[]{}{
        (A_1 \hto A_2) \intersection (A_3 \hto A_4) \equiv (A_1 \union A_3) \hto (A_2 \intersection A_4)
    }\\
