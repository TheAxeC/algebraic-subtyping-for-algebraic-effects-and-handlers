...
Two monomorphic typing contexts are equivalent if they subsume each other as seen in \textsc{Eq}. Definition \textsc{WeakeningMono} more concretely defines the $\le^\forall$ in terms of the domain of the monomorphic typing contexts.
...
\todo{explain proof reformulated typing judgements}
...
\begin{minipage}{0.95\columnwidth}
    ...
    \begin{mathpar}
      ...
      \inferrule[Do]{
        \ctxp \entt c_1 \T [\ctxm_1](A \E \dirt_1) \\
        \ctxp, \letvar \T [\ctxm_1]A \entt c_2 \T [\ctxm_2](B \E \dirt_2)
      }{
        \ctx \entt \doin{\letvar = c_1} c_2 \T [\ctxm_1 \intersection \ctxm_2](B \E (\dirt_1 \union \dirt_2))
      }
