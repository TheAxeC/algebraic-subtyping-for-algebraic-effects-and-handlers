...
\newcommand{\rectypep}[1]{\mu^+ \alpha . #1}
\newcommand{\rectypen}[1]{\mu^- \alpha . #1}
...
\newcommand{\prinent}{\triangleright}
\newcommand{\T}{\mathrel{:}}
\newcommand{\E}{\mathrel{!}}
...
\newcommand{\compty}{\kpost{computation}}
\newcommand{\casesty}{\kpost{handler\_cases}}
\newcommand{\ocamlbind}{\kord{>\!>\!=}}
\newcommand{\ocop}{\kord{op}}

% type automata
\newcommand{\enctype}{\mathcal{E}}
\newcommand{\dectype}{\mathcal{R}}
\newcommand{\functp}{\langle \to \rangle}
\newcommand{\handtp}{\langle \hto \rangle}
\newcommand{\booltp}{\langle \text{b} \rangle}
\newcommand{\dirttp}{\langle \text{drty} \rangle}
\newcommand{\optp}[1]{\langle{#1}{\rangle}}
\newcommand{\unknowntp}{\mathcal{X}}
\newcommand{\unknowndrttp}{\mathcal{D}}